 ...
 * @param onEvent The action to perform when a new event is observed, defined as a lambda expression taking an Event as a parameter
 */
@Suppress("ComposableParametersOrdering", "FunctionNaming")
@Composable
