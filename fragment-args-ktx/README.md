# fragment-args-ktx <GitLab path="android-research/knowledge/tree/master/libs/extensions/fragment-args-ktx"/>
...
dependencies {
    implementation("com.redmadrobot.extensions:fragment-args-ktx:1.0-rc1")
}
```
